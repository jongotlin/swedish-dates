...
class InternationalWomensDay implements DayInterface, DayOccurOnceAYearInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'Internationella kvinnodagen';
    }
    ...
    {
        return new \DateTime(sprintf('%s-03-08', $year));
    }
}
